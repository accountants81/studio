        ...
        <Card className="text-center py-12 shadow-lg">
          <CardContent>
            ...
            <Button asChild size="lg" className="group">
              <Link href="/products">
                تصفح المنتجات <ArrowLeft className="mr-2 h-5 w-5 transition-transform group-hover:-translate-x-1 rtl:rotate-180 rtl:group-hover:translate-x-1" />
              </Link>
            </Button>
          </CardContent>
        </Card>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
            ...
            {cartItems.map((item) => (
              <Card key={item.id} className="flex flex-col sm:flex-row items-center p-4 gap-4 shadow-md overflow-hidden">
                <div className="w-24 h-24 sm:w-32 sm:h-32 relative rounded-md overflow-hidden bg-muted flex-shrink-0">
                  <Image
                    src={item.images[0] || "https://picsum.photos/seed/cart/200"}
                    alt={item.name}
                    layout="fill"
                    objectFit="cover"
                ...
                <div className="flex-grow text-center sm:text-right">
                  ...
                  <p className="text-md font-semibold text-primary mt-1">{item.price} ج.م</p>
                </div>
                <div className="flex items-center space-x-3 rtl:space-x-reverse my-2 sm:my-0">
                ...
                <div className="text-md font-semibold w-28 text-center">
          ...
          <div className="lg:col-span-1">
            <Card className="sticky top-24 shadow-lg">
              ...
              <CardFooter>
                <Button asChild size="lg" className="w-full text-lg group" disabled={!isMinOrderValueMet}>
                  <Link href="/checkout">
                    متابعة إلى الدفع <ArrowLeft className="mr-2 h-5 w-5 transition-transform group-hover:-translate-x-1 rtl:rotate-180 rtl:group-hover:translate-x-1" />
                  </Link>
                </Button>
              </CardFooter>
            </Card>
